...
export const questions: Question[] = [
    ...
    },
    {
        ...
        testCases: new Map<Variable, Variable>([
            [{ value: 'abcabcbb', type: 'string' }, { value: 3, type: 'number' }],
            [{ value: 'bbbbb', type: 'string' }, { value: 1, type: 'number' }],
            [{ value: 'pwwkew', type: 'string' }, { value: 3, type: 'number' }]
        ])
    },
    
    {
        ...
        categories: ['numbers', 'algorithm'],
        testCases: new Map<Variable, Variable>([
            [{ value: 6, type: 'number' }, { value: 12, type: 'number' }],
            [{ value: 4, type: 'number' }, { value: 7, type: 'number' }],
            [{ value: 10, type: 'number' }, { value: 18, type: 'number' }]
        ])
    },
    
    {
        ...
        testCases: new Map<Variable, Variable>([
            [{ value: 16, type: 'number' }, { value: true, type: 'boolean' }],
            [{ value: 18, type: 'number' }, { value: false, type: 'boolean' }],
            [{ value: 25, type: 'number' }, { value: true, type: 'boolean' }]
        ])
    },
    {
        id: '12',
        ...
        categories: ['numbers', 'recursion'],
        testCases: new Map<Variable, Variable>([
            [{ value: 5, type: 'number' }, { value: 5, type: 'number' }],
            [{ value: 6, type: 'number' }, { value: 8, type: 'number' }],
            [{ value: 7, type: 'number' }, { value: 13, type: 'number' }]
        ])
    },
    
    {
        ...
        description: 'Determine if a given string is a palindrome. Consider the string case-insensitive and ignore any non-alphanumeric characters.',
    ...
    
    {
        ...
        description: 'Given a positive integer, count the number of 1s (set bits) in its binary representation.',
        ...
        testCases: new Map<Variable, Variable>([
            [{ value: 5, type: 'number' }, { value: 2, type: 'number' }],
            [{ value: 7, type: 'number' }, { value: 3, type: 'number' }],
            [{ value: 10, type: 'number' }, { value: 2, type: 'number' }]
        ])
    },
    {
        id: '15',
        ...
        categories: ['numbers'],
        testCases: new Map<Variable, Variable>([
            [{ value: 123, type: 'number' }, { value: 6, type: 'number' }],
            [{ value: 456, type: 'number' }, { value: 15, type: 'number' }],
            [{ value: 789, type: 'number' }, { value: 24, type: 'number' }]
        ])
    },
    
    {
        ...
        description: 'Given a positive integer n, return the nth triangular number. The nth triangular number is the sum of all integers from 1 to n.',
        ...
        categories: ['numbers', 'math'],
        testCases: new Map<Variable, Variable>([
            [{ value: 4, type: 'number' }, { value: 10, type: 'number' }],
            [{ value: 5, type: 'number' }, { value: 15, type: 'number' }],
            [{ value: 6, type: 'number' }, { value: 21, type: 'number' }]
        ])
    },
    
    {
        ...
        categories: ['numbers', 'algorithm'],
        testCases: new Map<Variable, Variable>([
            [{ value: 12, type: 'number' }, { value: [1, 2, 3, 4, 6, 12], type: 'array(number)' }],
            [{ value: 15, type: 'number' }, { value: [1, 3, 5, 15], type: 'array(number)' }],
            [{ value: 16, type: 'number' }, { value: [1, 2, 4, 8, 16], type: 'array(number)' }]
        ])
    },    
    {
        id: '18',
        title: 'Calculate Fibonacci Sequence',
        description: 'Given a positive integer n, return the first n numbers in the Fibonacci sequence as an array.',
        ...
        testCases: new Map<Variable, Variable>([
            [{ value: 5, type: 'number' }, { value: [0, 1, 1, 2, 3], type: 'array(number)' }],
            [{ value: 3, type: 'number' }, { value: [0, 1, 1], type: 'array(number)' }],
            [{ value: 6, type: 'number' }, { value: [0, 1, 1, 2, 3, 5], type: 'array(number)' }]
        ])
    },
    
    {
        ...
        categories: ['strings', 'algorithm'],
        testCases: new Map<Variable, Variable>([
            [{ value: 'abc123def45', type: 'string' }, { value: 168, type: 'number' }],
            [{ value: 'hello123', type: 'string' }, { value: 123, type: 'number' }],
            [{ value: '10cats20dogs', type: 'string' }, { value: 30, type: 'number' }]
        ])
    },
    
    {
        ...
        testCases: new Map<Variable, Variable>([
            [{ value: 16, type: 'number' }, { value: true, type: 'boolean' }],
            [{ value: 18, type: 'number' }, { value: false, type: 'boolean' }],
            [{ value: 32, type: 'number' }, { value: true, type: 'boolean' }]
        ])
    }    
]
